    ...
    function update()
        ...
        do
            ...
            do
                ...
                elseif k == "SReclaimable" then mem_now.src = math.ceil(v / 1024) 
                end
            end
        end

        mem_now.used = mem_now.total - mem_now.free - (mem_now.buf + mem_now.cache + mem_now.src)
        mem_now.swapused = mem_now.swap - mem_now.swapf
        mem_now.perc = math.ceil(mem_now.used / mem_now.total * 100)
